  ...
  <div class="parallax-container">
    ...
    <?php
      $dbconnect = pg_connect("dbname=group_cb user=group_cb password=123456") or die('fail to connect:'.pg_last_error());
            ...
            $products = pg_query("SELECT product_id, title FROM products ORDER BY title;");

            $employees = pg_query("SELECT e_id, e_name FROM employee ORDER BY e_name;");
            if(!$result) {
              echo "An error occured.\n";
              exit;
            }
            if(!$employees) {
              echo "employee query error\n";
              exit;
            }
            if(!$products) {
            ...
            $product = $_POST["product"];
              ...
              if(isset($employee) && isset($product)) {
  ...
  <div class="container">
    <div class="section">
        <div class="row">
           ...
           <div class="row">
              <h5>Change Administrator: </h5>
              <br><br>
              <div class="row">
                <form method=POST action="change_admin.php">
                <div class="col s4">
                        <select name="product">
